...
class SpecialFlow():
    @staticmethod
    def flip(size):
        # horizontal = np.random.randint(2, size=1)[0]
    ...
    def rotate(size):
        ...
        theta =np.deg2rad(utils.get_random(15, 10))
...
def augment_flow(img0, img0_depth, img0_mask, img1, img1_depth, img1_mask,
    ...
    special_flow, back_special_flow = None, None
    augment_type = utils.get_random(2, 0, False)
    if augment_type >= 1.:
